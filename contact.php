...
<head>
  ...
  <title>Hubungi Kami - Tokofurniture</title>
        ...
        <div class="col-lg-12">
          <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.php">
              <h1 class="m-o">Toko Furniture</h1>
            </a>
      ...
      <div class="d-none d-sm-block mb-5 pb-4">
        ...
        <div class="map-container">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.
            ...
            Cepu!5e0!3m2!1sid!2sid!4v1743766946322!5m2!1sid!2sid" width="100%" height="450" style="border:0;"
        ...
        <div class="col-lg-4">
          <div class="media contact-info">
            ...
            <div class="media-body">
              ...
              <p>Mentul Indah, 58315</p>
            </div>
          </div>
          <div class="media contact-info">
            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
            <div class="media-body">
              <h3>+62 838 3883 4132</h3>
              <p>Senin sampai Jum'at pukul 9 pagi - 6 sore</p>
            </div>
          </div>
          <div class="media contact-info">
            <span class="contact-info__icon"><i class="ti-email"></i></span>
            <div class="media-body">
              <h3>Tokofurniture@gmail.com</h3>
